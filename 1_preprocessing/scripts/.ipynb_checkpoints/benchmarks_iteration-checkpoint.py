...
def prepare_data(in_path, prediction_paths, endpoint, score, model, t_eval, output_path):
    ...
    temp_tte = pd.read_feather(f"{output_path}/data_outcomes_wide_230320.feather", 
...
def calculate_cindex(in_path, prediction_paths, endpoint, score, model, time, iteration, eids_i, output_path):  
    temp_data = prepare_data(in_path, prediction_paths, endpoint, score, model, time, output_path)
...
#@ray.remote
def calculate_iteration(in_path, prediction_paths, endpoint, scores, model, time, iteration, eids_e, output_path):  
    ...
    while valid==False:
        ...
        for score in scores:
            score_dict = calculate_cindex(in_path, prediction_paths, endpoint, score, model, time, iteration, eids_i, output_path)
